...
public class CradleErrorCollector implements ErrorCollector {
    private static final Logger LOGGER = LoggerFactory.getLogger(CradleErrorCollector.class);
    ...
    private void drain() {
        if (rootEvent == null || persistor == DYMMY_PERSISTOR) {
            LOGGER.warn( "{} isn't initialised", CradleErrorCollector.class.getSimpleName());
        }
